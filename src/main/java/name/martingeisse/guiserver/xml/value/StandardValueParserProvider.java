...
/**
 * This is an extension point to provide standard parsers based on Java types. Consider the case that a binding
 ...
 */
public interface StandardValueParserProvider {
